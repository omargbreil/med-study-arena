...
export default function Admin() {
   ...
   async function getUsers () {
        ...
        let {data}= await axios.get('https://study-arena.vercel.app/arena/v1/user');
        console.log(courses);
    ...
    async function deleteCourse(tid) {
        ...
        try {
            const response = await axios.delete(`https://study-arena.vercel.app/arena/v1/course/delete/${tid}`, {
                headers: {
                    'token': token,
                },
            });
